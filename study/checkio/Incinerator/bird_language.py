...
def translate(phrase):
    ...
    # remove vowel after consonant
    phrase = re.sub("([jzlxmbfhwcprqgskdtnv])(?!\1)[aeiouy]", '\g<1>', phrase)

    # remove excess letters (extra vowels)
    phrase = re.sub("([aeiouy]){3}", r'\g<1>', phrase)
