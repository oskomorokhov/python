#!/usr/bin/env checkio --domain=py run crossword-solver
...
if __name__ == '__main__':
    ...
    result, message = checker(
        solver, ['X.XX', '....', 'X.XX', 'X...', 'XXX.', '....', 'XXX.'],)
