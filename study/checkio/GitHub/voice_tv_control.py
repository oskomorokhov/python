...
<< << << < HEAD
   ...
   def __init__(self, channels):
        ...
        self.current_channel_i = self.channels[0]

    def first_channel(self):
        self.current_channel_i = self.channels[0]
        return self.current_channel_i

    def last_channel(self):
        self.current_channel_i = self.channels[-1]
        return self.current_channel_i

    def turn_channel(self, n):
        self.current_channel_i = self.channels[n-1]
        return self.current_channel_i

    def next_channel(self):
        self.current_channel_i = self.channels[(self.channels.index(self.current_channel_i)+1)%len(self.channels)]
        return self.current_channel_i

    def previous_channel(self):
        self.current_channel_i = self.channels[(self.channels.index(self.current_channel_i)-1)]
        return self.current_channel_i
    ...
    def is_exist(self, n):
        if type(n) ==int:
            return "Yes" if n-1 in range(0, len(self.channels)) else "No"
        elif type(n) ==str:
