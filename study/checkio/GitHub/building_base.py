...
class Building:
    ...
    def corners(self):
        return {'north-east': [self.south+self.width_NS, self.west+self.width_WE], 'south-east': [self.south, self.west+self.width_WE], 'south-west': [self.south, self.west], 'north-west': [self.south+self.width_NS, self.west]}
    ...
    def __repr__(self):
        return "{0}({1}, {2}, {3}, {4}, {5})".format(self.__class__.__name__,self.south,self.west,self.width_WE,self.width_NS,self.height)
