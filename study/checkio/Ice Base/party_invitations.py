...
# https://py.checkio.org/mission/party-invitations/
...
class Friend:
    ...
    def get_invite(self, place, datetime):
        self.place = place
        self.datetime = datetime

    def show_invite(self):
        if self.place == "" or self.datetime == "":
            return "No party..."
        else:
            return self.place+": "+self.datetime


class Party:
    def __init__(self, name="Generic Party"):
        self.name = name
        self.observers = []
    ...
    def send_invites(self, datetime):
        for e in self.observers:
            e.get_invite(self.name, datetime)
