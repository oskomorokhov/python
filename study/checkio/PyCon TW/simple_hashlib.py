...
# https://py.checkio.org/mission/simple_hashlib/
...
def checkio(hashed_string, algorithm):
    return eval('hashlib.'+algorithm+'('+'\''+hashed_string+'\''+'.encode()).hexdigest()')
...
if __name__ == '__main__':
    ...
    assert checkio(
        'happy spam', 'sha224') == '6e9dc3e01d57f1598c2b40ce59fc3527e698c77b15d0840ae96a8b5e'
